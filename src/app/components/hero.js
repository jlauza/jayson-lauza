...
export default function Hero() {
  ...
  return (
    <>
      <div className="relative min-h-screen bg-[url('/hero-background.png')] bg-cover bg-center hidden">
        {/* Gradient overlay */}
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-black/95 to-black" />
